        ...
        <ul class="cd-hero-slider mb-0 py-5">
          <li class="px-3" data-page-no="1">
            <div class="page-width-1 page-left">
              <div class="d-flex position-relative tm-border-top tm-border-bottom intro-container">
                ...
                <img src="<?php echo get_template_directory_uri(); ?>/img/home-img-1.jpg">
                <img src="<?php echo get_template_directory_uri(); ?>/img/home-img-2.jpg">
                </div>
          ...
          <li data-page-no="2">
            ...
            <div class="mx-auto position-relative gallery-container">
             ...
             <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-01.jpg">
                    <figcaption>
                        <div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-02.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-03.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-04.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-05.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-06.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-07.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-08.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
                ...
                <figure class="effect-julia item">
                <img src="<?php echo get_template_directory_uri(); ?>/img/gallery-img-09.jpg">
                    <figcaption>
                        <div>
                            <p>Julia dances in the deep dark</p>
                        </div>
